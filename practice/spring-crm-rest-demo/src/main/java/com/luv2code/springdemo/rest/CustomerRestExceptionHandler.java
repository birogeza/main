...
public class CustomerRestExceptionHandler {
	...
	// hozzunk létre egy kivételkezelõt a CustomerNotFoundException-re
	@ExceptionHandler
	public ResponseEntity<CustomerErrorResponse> handleException(CustomerNotFoundException cnfe){
		
		// hozzuk létre a CustomerErrorResponese-t
	...
	//hozzunk létre egy kivételkezelõt bármilyen más hibára
	@ExceptionHandler
